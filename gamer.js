...
function choose() {
	...
	var p1DOM = document.getElementById('chaves');
	var p2DOM = document.getElementById('prof');
...
function rockIt() {
	...
	if (score1 === 7) {
		...
		setTimeout(function() {
			alert(
				'Player 1 wins! refresh the page to play again!'
			);
		}, 4000);
	}
	...
	if (score2 === 7) {
		document
			.getElementById('prof')
			.classList.add('winner');
		document.querySelector('.dudel').innerHTML =
			'I win! I win!';
		setTimeout(function() {
			alert(
				'Player 2 wins! refresh the page to play again!'
			);
		}, 4000);
	}
...
document
	.querySelector('.playOn')
	.addEventListener('click', rockIt);
document
